...
//
//  Create the PNG file synchronously, reporting errors.
//
function GetPNG(result) {
  if (data.png) {
      console.log(result.svg);
      var rsvg = new Rsvg(result.svg);
      result.png = rsvg.render({format:'png',width:rsvg.width,height:rsvg.height}).data;
  }
}
